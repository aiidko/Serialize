...
public class SRArray extends SRBase{
	...
	public static SRArray Byte(String name, byte[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Char(String name, char[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Short(String name, short[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Integer(String name, int[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Long(String name, long[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Float(String name, float[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Double(String name, double[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Boolean(String name, boolean[] data){
		SRArray array = new SRArray();
		array.setName(name);
	...
	public static SRArray Deserialize(byte[] data, int pointer){
		byte containerType = data[pointer++];
		assert(containerType == CONTAINER_TYPE);
		
		SRArray result = new SRArray();
